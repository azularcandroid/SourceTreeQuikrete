 ...
 */
public class TypefaceTextView_Shimmer extends TextView  implements ShimmerViewBase{
    ...
    public TypefaceTextView_Shimmer(final Context context) {
        this(context, null);
        shimmerViewHelper = new ShimmerViewHelper(this, getPaint(), null);
        shimmerViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public TypefaceTextView_Shimmer(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
        shimmerViewHelper = new ShimmerViewHelper(this, getPaint(), attrs);
        shimmerViewHelper.setPrimaryColor(getCurrentTextColor());
    }

    public TypefaceTextView_Shimmer(final Context context, final AttributeSet attrs, final int defStyle) {
