...
public class ItemListAdapter_Project extends BaseAdapter {
	List<Project> itemList = new ArrayList<Project>();
	Context context;
	int layout;

	public ItemListAdapter_Project(Context c, int layout) {
		context = c;
		this.layout = layout;
	}
