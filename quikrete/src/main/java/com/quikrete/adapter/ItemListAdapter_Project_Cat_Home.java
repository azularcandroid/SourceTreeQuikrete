...
public class ItemListAdapter_Project_Cat_Home extends BaseAdapter {
	List<Homeowner> itemList = new ArrayList<Homeowner>();
	Context context;
	int layout;

	public ItemListAdapter_Project_Cat_Home(Context c, int layout) {
		context = c;
		this.layout = layout;
	}
	...
	@Override
	public Homeowner getItem(int position) {
	...
	public void addItem(Homeowner item) {
		itemList.add(item);
