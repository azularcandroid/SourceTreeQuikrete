...
public class ItemListAdapter_Product_Alph extends BaseAdapter {
    List<Alphabetical> itemList = new ArrayList<Alphabetical>();
    Context context;
    int layout;
    String id = "";

    public ItemListAdapter_Product_Alph(Context c, int layout) {
        context = c;
        this.layout = layout;
    }
    ...
    public View getView(final int position, View arg1, ViewGroup parent) {
        ...
        txt_star.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("AddRemoveFavourites", "Product_Alpha");
            }
        });
