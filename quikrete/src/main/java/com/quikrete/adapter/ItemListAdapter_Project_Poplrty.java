...
public class ItemListAdapter_Project_Poplrty extends BaseAdapter {
    List<Popularity> itemList = new ArrayList<Popularity>();
    Context context;
    int layout;
    String id = "";

    public ItemListAdapter_Project_Poplrty(Context c, int layout) {
        context = c;
        this.layout = layout;
    }
    ...
    public View getView(final int position, View arg1, ViewGroup parent) {
        ...
        txt_star.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("AddRemoveFavourites", "Project_Properly");
            }
        });
