...
import com.quikrete.adapter.ItemListAdapter_Video_Poplrty;
import com.quikrete.gsondata.videocat.Result;
import com.quikrete.gsondata.videocat.VideoCategoryData;
...
public class VideoListActivity extends Activity implements IXListViewListener {
	...
	private ItemListAdapter_Video_Poplrty mAdapterPoplrty;
	// private ItemListAdapter_Video_Alph mAdapterAlpb;
	...
	private void listViewInit() {
		// TODO Auto-generated method stub
		mAdapterPoplrty = new ItemListAdapter_Video_Poplrty(this,
				R.layout.list_view_row_video);
		// mAdapterAlpb = new ItemListAdapter_Video_Alph(this,
		// R.layout.list_view_row_video);
	...
	class AsyncLoadProductCategory extends
		...
		protected void onPreExecute() {
			...
			pdialog = ScreenUtils.returnProgDialogObj(context,
					"Loading Videos...please wait", false);
			pdialog.show();
			super.onPreExecute();
		}
		...
		protected List<Result> doInBackground(String... params) {
			...
			try {
				...
				if (params.length == 2) {
					...
					url = WebServiceUtil.URL
							+ WebServiceUtil.METHOD_3_GET_VIDEO_LIST;
				}
