...
import com.quikrete.adapter.ItemListAdapter_Calc;
import com.quikrete.gsondata.calc.CalculatorList;
...
public class CalculatorListActivity extends Activity implements
		IXListViewListener {
	...
	private ItemListAdapter_Calc mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		related = getIntent().getStringExtra("related");
		related_for = getIntent().getStringExtra("related_for");

		if (Utils.isNetworkAvailable(context))
			if (related == null) {
				new AsyncLoadCalculatorList().execute();
			} else if (related != null && related_for != null) {

				new AsyncLoadCalculatorList().execute(new String[] { related,
						related_for });
			} else
	...
	private void listViewInit() {
		// TODO Auto-generated method stub
		mAdapter = new ItemListAdapter_Calc(this, R.layout.list_view_row_calc);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.putExtra("title", mAdapter.getItem(arg2).getTitle());
				startActivity(intent);

				Log.e("Calculator", "Details---" + mAdapter.getItem(arg2).toString());


				Utils.getTracker(mAdapter.getItem(arg2).getTitle(), getApplication());
			}
		});
	}
	...
	public void onRefresh() {
		...
		//
		// // mAdapter.notifyDataSetChanged();
		// mAdapter = new ItemListAdapter_Calc(
		// CalculatorListActivity.this, R.layout.list_view_row);
		// mListView.setAdapter(mAdapter);
		// onLoad();
		// }
		// }, 2000);
	...
	class AsyncLoadCalculatorList extends
		...
		protected List<Result> doInBackground(String... params) {
			...
			try {
				...
				if (params.length == 2) {
					...
					url = WebServiceUtil.URL
							+ WebServiceUtil.METHOD_6_1_GET_CALCULATOR_LIST;
				}
