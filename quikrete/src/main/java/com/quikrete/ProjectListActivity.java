...
import com.quikrete.adapter.ItemListAdapter_Project_Alph;
import com.quikrete.adapter.ItemListAdapter_Project_Poplrty;
import com.quikrete.gsondata.projectcat.list.Alphabetical;
import com.quikrete.gsondata.projectcat.list.Popularity;
import com.quikrete.gsondata.projectcat.list.ProjectListData;
import com.quikrete.gsondata.projectcat.list.Result;
...
public class ProjectListActivity extends Activity implements IXListViewListener {
	...
	private ItemListAdapter_Project_Poplrty mAdapterPoplrty;
	private ItemListAdapter_Project_Alph mAdapterAlpb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		txt_main_label.setText("Product Search Results");
	...
	private String getSelectedName(int pos) {
	...
	private void listViewInit() {
		// TODO Auto-generated method stub
		mAdapterPoplrty = new ItemListAdapter_Project_Poplrty(this,
				R.layout.list_view_row_project_prd_code);
		mAdapterAlpb = new ItemListAdapter_Project_Alph(this,
				R.layout.list_view_row_project_prd_code);
	...
	class AsyncLoadProductCategory extends AsyncTask<String, String, Result> {
		...
		protected void onPreExecute() {
			...
			pdialog = ScreenUtils.returnProgDialogObj(context,
					"Loading Products...please wait", false);
			pdialog.show();
			super.onPreExecute();
		}
			...
			try {
				...
				if (params.length == 2) {
					nameValuePair.add(new BasicNameValuePair(
							WebServiceUtil.METHOD_2_1_1_GET_PROJECT_LIST_CAT,
							params[0]));
					nameValuePair.add(new BasicNameValuePair(
							WebServiceUtil.METHOD_2_1_2_GET_PROJECT_LIST_TYPE,
							params[1]));
					url = WebServiceUtil.URL
							+ WebServiceUtil.METHOD_2_1_GET_PROJECT_LIST;
					...
					Log.e("newlog", params[0] + "---" + params[1] + "---" + url);
				}
