...
public class HtmlTagHandler implements Html.TagHandler {
	...
	public void handleTag(final boolean opening, final String tag,
		...
		if (opening) {
			...
			if (tag.equalsIgnoreCase("ul") || tag.equalsIgnoreCase("ol")
				...
				end(output, Center.class, new AlignmentSpan.Standard(
	...
	private void end(Editable output, Class kind, Object repl,
	...
	private void handleListTag(Editable output) {
		if (mListParents.lastElement().equals("ul")) {
			...
			output.setSpan(
					new LeadingMarginSpan.Standard(15 * mListParents.size()),
