...
/**
 * <p/>
 * A {@link android.widget.TextView} that insert spaces around its text spans
 * where needed to prevent {@link IndexOutOfBoundsException} in
 * {@link #onMeasure(int, int)} on Jelly Bean.
 * <p/>
...
public class JellyBeanSpanFixTextView extends TextView {
	...
	private void fixSpannedWithSpaces(SpannableStringBuilder builder,
		...
		if (HtmlTextView.DEBUG) {
			...
			Log.d(HtmlTextView.TAG, "fixSpannedWithSpaces() duration in ms: "
					+ fixDuration);
		}
	}
