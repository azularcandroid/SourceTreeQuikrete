package com.quikrete.utils.html;
...
public class HtmlTextView extends JellyBeanSpanFixTextView {
	...
	/**
	 * http://stackoverflow.com/questions/309424/read-convert-an-inputstream-to-
	 * a-string
	 * 
	 * @param is
	 * @return
	...
	/**
	 * Loads HTML from a raw resource, i.e., a HTML file in res/raw/. This
	 * allows translatable resource (e.g., res/raw-de/ for german). The
	 * containing HTML is parsed to Android's Spannable format and then
	 * displayed.
	 * 
	 * @param context
	 * @param id
	 *            for example: R.raw.help
	 */
	public void setHtmlFromRawResource(Context context, int id,
			boolean useLocalDrawables) {
		// load html from html file from /res/raw
		InputStream inputStreamText = context.getResources()
				.openRawResource(id);
