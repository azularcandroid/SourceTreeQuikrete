...
public class SearchResultListActivity extends Activity implements
		IXListViewListener {
	...
	// RadioButton returnRadioButton(String info) throws Exception {
	//
	// RadioButton radioButton = (RadioButton) View.inflate(context,
	// R.layout.radiobutton_sample, null);
	//
	...
	private void listViewInit() {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				switch (radioGroup) {
				case 0:
					intent = new Intent(SearchResultListActivity.this,
	...
	protected void onResume() {
		...
		if (Utils.isNetworkAvailable(context))
			new AsyncLoadProductCategory()
					.execute(new String[] { keyword, type });
		else
	...
	class AsyncLoadProductCategory extends AsyncTask<String, String, Result> {
		...
		protected void onPreExecute() {
			...
			pdialog = ScreenUtils.returnProgDialogObj(context,
					"Loading Results...please wait", false);
			pdialog.show();
			super.onPreExecute();
		}
		...
		protected Result doInBackground(String... params) {
			...
			try {
				...
				nameValuePair.add(new BasicNameValuePair(
						WebServiceUtil.METHOD_11_1_GET_SEARCH_KEYWORD_KEY,
						params[0]));

				nameValuePair.add(new BasicNameValuePair(
						WebServiceUtil.METHOD_11_1_GET_SEARCH_KEYWORD_TYPE,
						params[1]));

				String url = WebServiceUtil.URL
						+ WebServiceUtil.METHOD_11_1_GET_SEARCH_KEYWORD;

				Log.e("newlog", params[0] + "----params[0]");
				Log.e("newlog", params[1] + "----params[1]");
